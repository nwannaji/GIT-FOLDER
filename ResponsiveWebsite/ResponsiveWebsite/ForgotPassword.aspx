            ...
            <div class ="form-horizontal">
                <br />
                  <h2>Recover Password</h2>
                    <hr />
                    <h4>Please enter your E-mail address, We will send you instructions to reset your password.</h4>
                <div class="form-group">
                    <asp:Label ID="lblEmailaddress" CssClass="col-md-2 control-label" runat="server" Text="Enter Your email:"></asp:Label>
                    <div class="col-md-3">
                        <asp:TextBox ID="tbemailAddress" CssClass="form-control" runat="server" TextMode="Email"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorEmailaddress" CssClass="text-danger" runat="server" ErrorMessage="Please enter your E-mail ID." ControlToValidate="tbemailAddress"></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:Button ID="btnPassRec" class="btn btn-default btn-info" runat="server" Text="Send" OnClick="btnPassRec_Click" />
