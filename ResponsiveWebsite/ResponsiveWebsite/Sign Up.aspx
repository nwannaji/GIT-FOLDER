                ...
                <div class ="container">
                    <div class="navber-header">
                       <button type ="button" class ="navbar-toggle"style="background-color:white" data-toggle="collapse" data-target=".navbar-collapse">
                        ...
                        <a class="navbar-brand" href="Default.aspx"><span style="font-family:'Harlow Solid';font-weight:700;font-size:x-large;color:red"><img  src="Images/unisex.jpg" alt="logo" height="35"/>e-Boutique</span></a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class ="nav navbar-nav navbar-right">
                            ...
                            <li class ="active" style ="font-weight:700"><a style="font-weight:700;color:red" href="Sign Up.aspx">Sign Up</a></li>
                         </ul>
                    </div>
                </div>
            </div>
