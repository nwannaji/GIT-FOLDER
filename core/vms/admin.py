...
class EmployeeAdmin (admin.ModelAdmin):
    ...
    list_display = ('employee_name','dept_name','unit','email_address','phone_number','is_Admin',)
    search_fields = ('employee_name','dept_name','unit','email_address',)
